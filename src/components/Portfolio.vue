...
//   const data = await fetch("../assets/json/portfolio.json");
//   response.value = await data.json();
//   console.log(response.value);
// };

// const fetchModals = async () => {
//   const data = await fetch("../assets/json/modal.json");
            ...
            <!-- <div class="col-lg-6 offset-lg-1">
              <div class="right-info">
                <div class="fun-factor-default">
                  <div class="fun-fact">
                    <div class="counter">
                      <div class="timer" data-to="276" data-speed="2000">
                        276
                      </div>
                  ...
                  <div class="row">
                    <div class="col-xl-12 left-info">
                      ...
                      <p>
                        ...
                        dictum natoqu. Tempor nonummy metus lobortis. Sociis
                        ...
                        varius quisque class convallis praesent est sollicitudin
